...
describe('Quadratic Equations Test ', function () {
  ...
  it('Should create a Quadratic circuit verifier successfully', async () => {
    ...
    console.log('creatingwitness')
    witness = await circuit.calculateWitness({ x: '3', a: '2', b: '2', c: '4', res: '28' }, true)
    console.log('createdwitness')
    assert(Fr.eq(Fr.e(witness[0]), Fr.e(1)))
    console.log(Fr.eq(Fr.e(witness[0]), Fr.e(1)))

    assert(Fr.eq(Fr.e(witness[1]), Fr.e(expectedOutput)))
    console.log('witness1', Fr.e(witness[1]))
    // console.log('expectedout', Fr.e(expectedOutput))

    witness = await circuit.calculateWitness({ x: '3', a: '2', b: '2', c: '4', res: '30' }, true)
